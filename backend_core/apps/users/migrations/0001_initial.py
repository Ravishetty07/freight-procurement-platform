# Generated by Django 5.2.11 on 2026-02-12 14:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('ORG', 'Organization (Shipper)'), ('VENDOR', 'Vendor (Freight Forwarder)')], default='ADMIN', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('scac_code', models.CharField(help_text='Standard Carrier Alpha Code', max_length=10)),
